...
<#-- VIVO overlay: adds the built-in scholarly data ingest tool (PubMed / NIH RePORTER) -->
...
<#if dataTools?has_content>
    <section class="pageBodyGroup" role="region">
        ...
        <ul role="navigation">
            ...
            <li role="listitem"><a href="${urls.base}/dataIngest" title="Scholarly data ingest">Scholarly data ingest (PubMed / NIH RePORTER)</a></li>
